package com.upely.secretconfig.init;
...
import com.upely.secretconfig.common.util.RandomUtil;
...
public class EncryptService {
    ...
    private static final String REDIS_LOCK = "SECRET-CONFIG_com.upely.secretconfig.init.EncryptService_INIT";
